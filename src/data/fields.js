export const fields = [
  { 
    title: "Agriulture, Food and Natural Resources",
    jobs: [
      {
        name: 'Agricultural Equipment Operators',
        url: 'https://www.recruiter.com/careers/agricultural-equipment-operators/'
      },
      {
        name: 'Agricultural Sciences Teachers',
        url: 'https://www.recruiter.com/careers/postsecondary-agricultural-sciences-teachers/'
      },
      {
        name: 'Animal Breeders',
        url: 'https://www.recruiter.com/careers/animal-breeders/'
      },
      {
        name: 'Animal Scientists',
        url: 'https://www.recruiter.com/careers/animal-scientists/'
      },
      {
        name: 'Environmental Engineers',
        url: 'https://www.recruiter.com/careers/environmental-engineers/'
      },
      {
        name: 'Fallers',
        url: 'https://www.recruiter.com/careers/fallers/'
      },
      {
        name: 'Crop Farmworkers and Laborers',
        url: 'https://www.recruiter.com/careers/crop-farmworkers-and-laborers/'
      },
      {
        name: 'Food Scientists and Technologists',
        url: 'https://www.recruiter.com/careers/food-scientists-and-technologists/'
      },
      {
        name: 'Foresters',
        url: 'https://www.recruiter.com/careers/foresters/'
      },
      {
        name: 'Gas Plant Operators',
        url: 'https://www.recruiter.com/careers/gas-plant-operators/'
      },
      {
        name: 'Veterinarians',
        url: 'https://www.recruiter.com/careers/veterinarians/'
      },
    ]
  },
  { 
    ...
    jobs: [
      {
        name: 'Architects',
        url: 'https://www.recruiter.com/careers/architects-not-including-landscape-and-naval/'
      },
      {
        name: 'Brickmasons and Blockmasons',
        url: 'https://www.recruiter.com/careers/brickmasons-and-blockmasons/'
      },
      {
        name: 'Carpenters',
        url: 'https://www.recruiter.com/careers/carpenters/'
      },
      {
